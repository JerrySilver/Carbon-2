...
<form class="form-signin">
  ...
  <h1 class="h3 mb-3 font-weight-normal">管理员注册</h1>

  <label for="lastname" class="sr-only">姓</label>
  <input type="text" id="lastname" class="form-control" placeholder="姓" required autofocus>

  <label for="firstname" class="sr-only">名字</label>
  <input type="text" id="firstname" class="form-control" placeholder="名字" required autofocus>
